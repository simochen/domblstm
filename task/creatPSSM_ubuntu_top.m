...
%}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
swfile='/home/zhangyize/CreatPSSM/';
...
for s=1
    for k=1
        for o=362
            if (mod(o,comm_size)~=my_rank)
                continue;
            end
            intitle01=[swfile,'SeqFasta/'];
